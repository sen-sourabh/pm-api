  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    try {
      await queryRunner.query(
        `INSERT INTO users (firstName, organizationName, organizationPosition, noOfEmployees, email, password, secretKey, phoneNumber, roleId, usertypeId) VALUES ('admin', 'Sample Org.', 'HR', 100, 'admin@yopmail.com', 'Welcome@123', 'uey!rs@2id=', 124567890, 1, 1)`,
      );
